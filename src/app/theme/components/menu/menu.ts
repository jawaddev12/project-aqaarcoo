...
export const horizontalMenuItems = [ 
    ...
    new Menu (2, 'SALE', '/SALE', null, null, false, 0), 
    new Menu (2, 'RENT', '/RENT', null, null, false, 0), 
    // new Menu (2, 'dailyrent', '/dailyrent', null, null, false, 0), 
 ...
 //   new Menu (46, 'NAV.PRICING', '/pricing', null, null, false, 40), 
  ...
  //  new Menu (47, 'Terms & Conditions', '/terms-conditions', null, null, false, 0), 
  //  new Menu (47, 'privacy-policy', '/privacy-polic', null, null, false, 0),  
  //   new Menu (60, 'NAV.CONTACT', '/contact', null, null, false, 0),  
    new Menu (70, 'NAV.ABOUT_US', '/about', null, null, false, 0),   
    new Menu (71, 'Articles', '/Articles', null, null, false, 0), 
...
export const verticalMenuItems = [ 
    new Menu (1, 'NAV.HOME', '/', null, null, false, 0), 
    new Menu (2, 'SALE', '/SALE', null, null, false, 0), 
    new Menu (3, 'RENT', '/RENT', null, null, false, 0), 
    // new Menu (2, 'dailyrent', '/dailyrent', null, null, false, 0), 
    new Menu (71, 'Articles', '/Articles', null, null, false, 0), 
   // new Menu (40, 'NAV.PAGES', null, null, null, true, 0),
 //  new Menu (41, 'NAV.AGENTS', '/agents', null, null, false, 40), 
    // Menu (42, 'NAV.AGENT', '/agents/1', null, null, false, 40),
   // new Menu (43, 'LOGIN', '/login', null, null, false, 40), 
   // new Menu (44, 'REGISTER', '/register', null, null, false, 40),   
  //  new Menu (45, 'FAQs', '/faq', null, null, false, 40),
  //  new Menu (46, 'NAV.PRICING', '/pricing', null, null, false, 40), 
    // new Menu (47, 'TERMS_CONDITIONS', '/terms-conditions', null, null, false,0),  
    // new Menu (47, 'PRIVACY POLIC', '/privacy-polic', null, null, false, 0),  
   // new Menu (48, 'Landing', '/landing', null, null, false, 40), 
  //  new Menu (50, '404 Page', '/404', null, null, false, 40),
    // new Menu (60, 'NAV.CONTACT', '/contact', null, null, false, 0),  
    new Menu (70, 'NAV.ABOUT_US', '/about', null, null, false, 0),    
