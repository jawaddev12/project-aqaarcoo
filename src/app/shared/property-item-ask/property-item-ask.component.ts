...
@Component({
  selector: 'app-property-item-ask',
  templateUrl: './property-item-ask.component.html',
  styleUrls: ['./property-item-ask.component.scss']
})
export class PropertyItemAskComponent implements OnInit {
  ...
  public out = "hello world".replace(/\s/g, "");
  public slugar :string;
  public slugen :string;
  public slugtr :string;
  public slugfr :string;
  ...
  ngOnInit() {  
    ...
    /*
     this.slugar=this.property.titlear.replace(/\s/g, "-");

     this.slugen=this.property.titleEn.replace(/\s/g, "-");
     this.slugtr=this.property.titleTr.replace(/\s/g, "-");
     this.slugfr=this.property.titleFr.replace(/\s/g, "-");
     */
   // console.log("the adress is" + this.slugar);
  }
