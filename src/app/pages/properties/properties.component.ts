...
export class PropertiesComponent implements OnInit {
  ...
  public filterData(data,propertytype){
    return this.appService.filterData(data, this.searchFields, this.sort, this.pagination.page, this.pagination.perPage,this.settings.countrykind,propertytype);
  }
