...
public pergage:number;
  ...
  public id:any;
  public result:any;
  constructor(public appSettings:AppSettings, public appService:AppService, public mediaObserver: MediaObserver,private activatedRoute: ActivatedRoute, private route:ActivatedRoute,) {
  ...
  if(this.id) { this.catrgoryresult=this.id;}
   else if(this.searchFields?.propertyType)
...
console.log('this.catrgoryresult' + this.id)
    this.appService.getProperties('SALE',this.cityresult,this.catrgoryresult,this.neighborhoodresult,this.nbrBedRoomsresult,this.searchresult,this.Typenit1result,this.pagenumber).subscribe((data) => {    
      var  res : any = data;
      if (res.success) 
        {
  ...
  public filterData(data){
     ...
     return this.appService.filterData(data, this.searchFields, this.sort, this.pagination.page,16);
   }
