  ...
  constructor(public appSettings:AppSettings, 
    ...
    this.appService.getProperties().subscribe(data => { 
      this.route.paramMap.subscribe((params:ParamMap)=>{
        ...
        this.property = this.filterDatashow(data,Number(this.id)); 
...
public filterDatashow(data,id){
  ...
  /*
  if(this.settings.languageto == "ar"){
 //  window.location.pathname="properties/"+slug;
    data = data.find(Property => Property.id === id)
  }
  if(this.settings.languageto == "en")
  {
    //window.location.pathname="properties/"+slug;
    data = data.find(Property => Property.id === id)
  }
