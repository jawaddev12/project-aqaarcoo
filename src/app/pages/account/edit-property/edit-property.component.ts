...
export class EditPropertyComponent implements OnInit {
  ...
  ngOnInit() {
   ...
   // this.appService.getPropertyTypes().subscribe((Response)=>{this.propertyTypes=Response;})
   // this.typees = this.appService.gettypees();
// this.appService.getCities().subscribe((Response)=>{this.cities=Response;})
 //this.appService.region().subscribe((Response)=>{this.neighborhoods=Response;})
  ...
  public getPropertyById(id){
    this.appService.getPropertyById(id).subscribe(data=>{
      ...
      this.submitForm.controls.basic.get('title').setValue(this.property.titleEn);
      ...
      this.typees.forEach(status =>{
        this.property.type.forEach(name=>{
          if(status.name == name){
            statusList.push(status);
          }
        })       
      })
      this.submitForm.controls.basic.get('type').setValue(statusList);
      ...
      this.submitForm.controls.additional.get('nbrBedRooms').setValue(this.property.nbrBedRooms);  
      this.submitForm.controls.additional.get('nbrBathroom').setValue(this.property.nbrBathroom);  
  ...
  onSubmitForm(form){
    if(this.submitForm.get(form).valid){
      this.nextStep();
      if(form == "media"){
        this.snackBar.open('The property "' + this.property.titleEn + '" has been updated.', '×', {
