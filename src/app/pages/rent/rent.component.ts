...
public pergage:number;
  ...
  if(this.id) { this.catrgoryresult=this.id;}
   ...
   { this.nbrBedRoomsresult=this.searchFields?.bedrooms.from;}else this.nbrBedRoomsresult=this.removedSearchField;
    ...
    this.appService.getProperties('RENT',this.cityresult,this.catrgoryresult,this.neighborhoodresult,this.nbrBedRoomsresult,this.searchresult,this.Typenit1result,this.pagenumber).subscribe((data) => {    
      var  res : any = data;
      if (res.success) 
        {
